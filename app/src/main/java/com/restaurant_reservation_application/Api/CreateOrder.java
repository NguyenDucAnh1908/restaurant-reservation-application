package com.restaurant_reservation_application.Api;

import com.restaurant_reservation_application.Constant.AppInfo;
import com.restaurant_reservation_application.Helper.Helpers;
...
public class CreateOrder {
    private class CreateOrderData {
        ...
        private CreateOrderData(String amount) throws Exception {
            ...
            Items = "[]";
            BankCode = "zalopayapp";
            Description = "Thanh toán dịch vụ trên Group 5 Dem - #" + Helpers.getAppTransId();
